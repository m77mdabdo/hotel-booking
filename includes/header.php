	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	...
	        	<li class="nav-item"><a href="<?php echo APPURL; ?>/rooms.html" class="nav-link">Apartment Room</a></li>
			  ...
			  <li class="nav-item dropdown">
               ...
               <li><a class="dropdown-item" href="<?php echo APPURL; ?>/handel/logout.php">Logout</a></li>
             </ul>
        </li>
        <?php endif ; ?>
	        </ul>
