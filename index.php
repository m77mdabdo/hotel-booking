                ...
                <div class="room-wrap d-md-flex">
                    ...
                    <div class="half left-arrow d-flex align-items-center">
                        <div class="text p-4 p-xl-5 text-center">
                            ...
                            <h3 class="mb-3"><a
                                    href="room-single.php?id=<?php  echo $room->id ;?>"><?php  echo $room->name;?></a>
                            </h3>
                            ...
                            <p class="pt-1"><a href="room-single.php?id=<?php  echo $room->id ;?>"
        ...
        <div class="row justify-content-center">
            <div class="col-md-9 text-center">
                ...
                <p class="mb-4">It’s safe to book online with us! Get your dream stay in clicks or drop us a line with
                    your questions.</p>
                <p class="mb-0"><a href="<?php echo APPURL; ?>/about.php" class="btn btn-primary px-4 py-3">Learn
                        More</a> <a href="<?php echo APPURL ; ?>/contact.php" class="btn btn-white px-4 py-3">Contact
                        us</a></p>
            </div>
        </div>
    </div>
